...
class AttentionModule_stage0(nn.Module):
    # input size is 112*112*112
    def __init__(self, in_channels, out_channels, size1=(112, 112, 112), size2=(56, 56, 56), size3=(28, 28, 28), size4=(14, 14, 14)):
        ...
        self.interpolation1 = nnn.Upsample(size=size1)
...
class AttentionModule_stage1(nn.Module):
    # input size is 56*56*56
    def __init__(self, in_channels, out_channels, size1=(56, 56, 56), size2=(28, 28, 28), size3=(14, 14, 14)):
...
class AttentionModule_stage2(nn.Module):
    # input image size is 28*28*28
    def __init__(self, in_channels, out_channels, size1=(28, 28, 28), size2=(14, 14, 14)):
...
class AttentionModule_stage3(nn.Module):
    # input image size is 14*14*14
    def __init__(self, in_channels, out_channels, size1=(14, 14, 14)):
...
class AttentionModule_stage1_cifar(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, size1=(16, 16, 16), size2=(8, 8, 8)):
        ...
        self.interpolation1 = nn.Upsample(size=size2)

        self.up_residual_blocks1 = ResidualBlock(in_channels, out_channels)

        self.interpolation2 = nn.Upsample(size=size1)
...
class AttentionModule_stage2_cifar(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, size=(8, 8, 8)):
        ...
        self.interpolation1 = nn.Upsample(size=size)
