...
class Trainer:
    ...
    def save_model_train_loss(self, n_epoch, save_path):
        self.lastmodel_train_loss = "/data/data_cotune_l2/{}-densenet_min_train_loss_model_classification3d_array-{}-56.pth".format(save_path, self.random_state)
        torch.save(
            {
    ...
    def save_model_valid_loss(self, n_epoch, save_path):
        self.lastmodel_valid_loss = "/data/data_cotune_l2/{}-densenet_min_valid_loss_model_classification3d_array-{}-56.pth".format(save_path, self.random_state)
        torch.save(
            {
                "model_state_dict": self.model.state_dict(),
                "optimizer_state_dict": self.optimizer.state_dict(),
    ...
    def save_model_valid_ROC(self, n_epoch, save_path):
        self.lastmodel_valid_ROC = "/data/data_cotune_l2/{}-densenet_max_valid_ROC_model_classification3d_array-{}-56.pth".format(save_path, self.random_state)
        torch.save(
            {
                "model_state_dict": self.model.state_dict(),
                "optimizer_state_dict": self.optimizer.state_dict(),
    ...
    def save_model_valid_fscore(self, n_epoch, save_path):
        self.lastmodel_valid_fscore = "/data/data_cotune_l2/{}-densenet_max_valid_fscore_model_classification3d_array-{}-56.pth".format(save_path, self.random_state)
        torch.save(
            {
                "model_state_dict": self.model.state_dict(),
                "optimizer_state_dict": self.optimizer.state_dict(),
